...
export default function Sidebar({ onNavigate }) {
  ...
  const groups = [
    ...
    },
    {
      label: 'Operación',
      items: [
        { to: '/app/mi-jornada', label: 'Jornada' },
        hasModule('taller') ? { to: '/app/taller', label: moduloTaller } : null,
        (canEdit && hasModule('taller')) ? { to: '/app/aprobaciones', label: 'Aprobaciones' } : null,
    ...
    },
    {
      ...
      items: [
        ...
        hasModule('inventario') ? { to: '/app/repuestos', label: repuestoPlural } : null,
        hasModule('inventario') ? { to: '/app/stock', label: 'Stock', prep: true } : null,
        { to: '/app/documentacion', label: 'Documentación', prep: true },
        { to: '/app/mantenimiento', label: 'Planes de Mantenimiento', prep: true },
      ].filter(Boolean),
    },
    {
      label: 'Comercial',
      hide: !canEdit,
      items: [
        hasModule('crm') ? { to: '/app/leads', label: 'Oportunidades' } : null,
        ...
        hasModule('alquileres') && permiteAlquileres ? { to: '/app/alquileres', label: 'Alquileres' } : null,
      ].filter(Boolean),
    },
    {
      label: 'Finanzas',
      ...
      items: [
        ...
        { to: '/app/estado-resultados', label: 'Resultados', prep: true },
      ].filter(Boolean),
    },
    {
      label: 'Dirección',
      hide: !isOwner,
      items: [
        { to: '/app/ceo', label: 'Panel Dirección' },
        ...
        { to: '/app/ia-silenciosa', label: 'IA Operativa', prep: true },
      ].filter(Boolean),
    },
    {
      label: 'Sistema',
